...
public class Email {
    ...
    public boolean enviar(String asunto, String contenido ,String nombres,String apellidos,String correo){
        try {
            init();
            mimeMessage.setSubject(asunto);
            mimeMessage.setText(nombres+apellidos+contenido+correo);
